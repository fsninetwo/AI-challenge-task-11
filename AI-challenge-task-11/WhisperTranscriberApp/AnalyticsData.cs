...
public sealed class AnalyticsData
{
    ...
    [JsonPropertyName("speaking_speed_wpm")]
    public double SpeakingSpeedWpm { get; init; }

    [JsonPropertyName("frequently_mentioned_topics")]
    public List<TopicFrequency> FrequentlyMentionedTopics { get; init; } = new();
